...
-- SELECT title, rating
-- FROM games ORDER BY rating DESC

--Task 5

-- SELECT title, release_year
-- FROM games ORDER BY release_year

--Task 6

-- SELECT platform, title, rating
-- FROM games ORDER BY platform, rating DESC
...
-- SELECT title, release_year
-- FROM games
-- WHERE release_year < 2020 ORDER BY release_year
...
-- SELECT title, genre
-- FROM games
-- WHERE title ILIKE 'mario%' AND rating = 8.8 ORDER BY genre
